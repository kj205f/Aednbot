...
function createTicketTypeRow(disabled = false) {
...
async function handleTicketType(
  ...
  if (
    topic.includes("ticketType:") &&
    !topic.includes("ticketType:none")
  ) {
